...
describe TasksController do
  describe "route generation" do
    ...
    it "should map { :controller => 'tasks', :action => 'update', :id => 1} to /tasks/1" do
      route_for(:controller => "tasks", :action => "update", :id => 1, :product_id => '1', :story_id => '1').should == "/products/1/stories/1/tasks/1"
    end
  
    it "should map { :controller => 'tasks', :action => 'destroy', :id => 1} to /products/1/stories/1/tasks/1" do
      route_for(:controller => "tasks", :action => "destroy", :id => 1, :product_id => '1', :story_id => '1').should == "/products/1/stories/1/tasks/1"
    end
  end
