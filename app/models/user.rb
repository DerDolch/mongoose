...
class User < ActiveRecord::Base
  ...
  # validates_length_of       :first_name,    :within => 3..200
  ...
  # validates_length_of       :last_name,    :within => 3..200
  ...
  attr_accessible :login, :email, :first_name, :last_name, :password, :password_confirmation, :user_status_id
